const conditions = {
  cond1: {
    ...
    tooltip: "Badger staking on 12/01, 12/29, 1/8, 1/18",
  },
  cond2: {
    condition: "Badger staking and LP after Digg launch",
    tooltip: "Badger staking on 1/26, 2/11, 2/28, 3/17",
  },
  cond3: {
    condition: "In a non-native Sett since Badger Launch",
    tooltip: "Sett balance > 0 on 12/10, 1/8, 2/11, 3/17",
  },
  cond4: {
    condition: "Digg staker and LP after Digg Launch",
    tooltip: "Digg staking > 0 on 1/26, 2/11, 2/28, 3/17",
  },
  cond5: {
    condition: "Digg supporter below peg",
    tooltip: "Balance higher on 3/17 than 2/18",
  },
  cond6: {
